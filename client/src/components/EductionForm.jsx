...
//     const updated = [...data];
//     updated[index] = { ...updated[index], [field]: value };onChange(updated);
//   };
...
//                     type="text"
//                     className="px-3 py-2 text-sm rounded-lg w-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
//                     placeholder="add degree eg(bachelor's,Master's etc"
//                   />
//                 </div>
//                 <div>
//                   <input
...
//                     }
//                     type="month"
//                     placeholder="add graduation data"
...
//                     }
//                     type="text"
//                     placeholder="add your GPA or percentage"
//                     className="px-3 py-2 text-sm"
//                   />
//                 </div>
//               </div>
