  ...
  return (
    <div className="max-w-4xl mx-auto px-10 py-12 bg-white text-gray-900 font-light leading-relaxed">
      ...
      <header className="mb-12 border-b border-gray-200 pb-6">
        ...
        {data.personal_info?.profession && (
          <p className="uppercase text-gray-600 font-medium text-sm tracking-[0.15em] mb-3">
            {data.personal_info.profession}
          </p>
        )}
      ...
      {data.experience && data.experience.length > 0 && (
        <section className="mb-12">
          <h2
            className="text-base uppercase tracking-[0.15em] mb-6 font-medium border-l-4 pl-3"
